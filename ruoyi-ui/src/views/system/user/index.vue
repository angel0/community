      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="社区" align="center" key="deptName" prop="dept.deptName" v-if="columns[3].visible"
                           :show-overflow-tooltip="true"/>
<!--          <el-table-column label="门牌号" align="center" key="deptName" prop="dept.deptName" v-if="columns[7].visible"-->
<!--                           :show-overflow-tooltip="true"/>-->
<!--          <el-table-column label="车牌号" align="center" key="deptName" prop="dept.deptName" v-if="columns[8].visible"-->
<!--                           :show-overflow-tooltip="true"/>-->
<!--          <el-table-column label="车位号" align="center" key="deptName" prop="dept.deptName" v-if="columns[9].visible"-->
<!--                           :show-overflow-tooltip="true"/>-->
