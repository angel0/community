<template>
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="任务名称称" prop="name">
        <el-input v-model="queryParams.name" placeholder="请输入任务名称称" clearable style="width: 240px;"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="info" icon="el-icon-upload2" size="mini" @click="handleImport"
                   v-hasPermi="['bpm:model:import']">上传流程</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="110px">
        ...
        <el-form-item label="任务名称称" prop="name">
          <el-input v-model="form.name" placeholder="请输入任务名称称" :disabled="!!form.id" clearable />
        </el-form-item>
      ...
      <el-upload ref="upload" :limit="1" accept=".bpmn, .xml" :headers="upload.headers" :action="upload.url"
        ...
        <div class="el-upload__tip" slot="tip">
          <el-form ref="uploadForm" size="mini" label-width="90px" :model="upload.form" :rules="upload.rules" @submit.native.prevent>
            ...
            <el-form-item label="任务名称称" prop="name">
              <el-input v-model="upload.form.name" placeholder="请输入任务名称称" clearable />
            </el-form-item>
            <el-form-item label="流程描述" prop="description">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        name: [{ required: true, message: "任务名称称不能为空", trigger: "blur" }],
        formType: [{ required: true, message: "任务名称称不能为空", trigger: "blur" }],
  ...
  methods: {
    ...
    handleChangeState(row) {
      ...
      this.$modal.confirm('是否确认' + statusState + '任务名称字为"' + row.name + '"的数据项?').then(function() {
