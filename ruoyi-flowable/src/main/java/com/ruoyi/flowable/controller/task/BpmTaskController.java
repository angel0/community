...
public class BpmTaskController {
    ...
    public AjaxResult getTodoTaskPage(@Valid BpmTaskTodoPageReqVO pageVO) {
        return AjaxResult.success(taskService.getTodoTaskPage(SecurityUtils.getUserId(), pageVO));
    }
    ...
    public AjaxResult getDoneTaskPage(@Valid BpmTaskDonePageReqVO pageVO) {
        return AjaxResult.success(taskService.getDoneTaskPage(SecurityUtils.getUserId(), pageVO));
    }
    ...
    public AjaxResult getTaskListByProcessInstanceId(
        ...
        return AjaxResult.success(taskService.getTaskListByProcessInstanceId(processInstanceId));
    }
    ...
    public AjaxResult getBackNodesByProcessInstanceId(@PathVariable String processInstanceId,@PathVariable String taskId) {
        return AjaxResult.success(taskService.getBackNodesByProcessInstanceId(processInstanceId,taskId));
    }
